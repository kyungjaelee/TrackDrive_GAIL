function axisinfo = plot_track_darker(track)


% colors = flipud(jet(track.nr_seg)); % <= Colorful lanes
colors = 0.1*ones(track.nr_seg, 3); % <= Gray lanes
...
for i = fliplr(1:track.nr_seg)
    ...
    % Fiell
    fill(curr_bd(:, 1), curr_bd(:, 2), 0.3*[1 1 1],'LineStyle','none');
    ...
    switch curr_type
        case 'straight'
            for j = 1:nr_lane - 1
                ...
                plot([a(1) b(1)], [a(2) b(2)], '--', 'Color', 'w', 'LineWidth', 2);
            end
        case 'right_turn'
            l1 = track.seg{i}.l1;
            ...
            for j = 1:nr_lane - 1
                ...
                plot(ltemp(:, 1), ltemp(:, 2), '--', 'Color', 'w', 'LineWidth', 2);
            end
        case 'left_turn'
            l1 = track.seg{i}.l1;
            l2 = flipud(track.seg{i}.l2);
...
plot([startp1(1) startp4(1)], [startp1(2) startp4(2)], 'r-', 'LineWidth', 3);
